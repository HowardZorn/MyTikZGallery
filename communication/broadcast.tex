...
\node[box, below=of right1] (right2) {\itshape\huge\color{red}a};
\node[box, below=of right2] (right3) {\itshape\huge\color{red}a};

% 连接线
% 从node1 (a) 出发的线
\draw[red, thick] (node1.east) -- (right1.west);
